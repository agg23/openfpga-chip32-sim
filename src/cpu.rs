...
use crate::{mem::Memory, util::num::LowerWord};
...
impl CPU {
    pub fn step(&mut self) {
        ...
        match inst_prefix_byte {
            ...
            0x08 | 0x18 => self.basic_alu(inst_suffix_byte, false, alu_32_bit, |_, immediate| {
                // ld Rx,#16
                (immediate, false)
            }),
            0x09 | 0x19 => self.basic_alu(inst_suffix_byte, false, alu_32_bit, |reg, immediate| {
                // and Rx,#16
                (reg & immediate, false)
            }),
            0x0A | 0x1A => self.basic_alu(inst_suffix_byte, false, alu_32_bit, |reg, immediate| {
                // or Rx,#16
                (reg | immediate, false)
            }),
            0x0B | 0x1B => self.basic_alu(inst_suffix_byte, false, alu_32_bit, |reg, immediate| {
                // xor Rx,#16
                (reg ^ immediate, false)
            }),
            0x0C | 0x1C => self.basic_alu(inst_suffix_byte, true, alu_32_bit, |reg, immediate| {
                // add Rx,#16
                reg.overflowing_add(immediate)
            }),
            0x0D | 0x1D => self.basic_alu(inst_suffix_byte, true, alu_32_bit, |reg, immediate| {
                // sub Rx,#16
